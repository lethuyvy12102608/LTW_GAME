                            ...
                            <div class="single-slide align-center-left  animation-style-01 bg-1">
                                ...
                                <div class="slider-content">
                                    ...
                                    <div class="default-btn slide-btn">
                                        <a class="links" href="shop2.jsp">Shopping Now</a>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="product_desc_info">
                                            <div class="product-review">
                                                <h5 class="manufacturer">
                                                    <a href="shop2.jsp">Graphic Corner</a>
                                                </h5>
                                            ...
                                            <h4><a class="product_name" href="detailProduct.jsp">Accusantium
                                                dolorem1</a></h4>
                                            <div class="price-box">
                                ...
                                <div class="single-product-wrap">
                                    ...
                                    <div class="product_desc">
                                        <div class="product_desc_info">
                                            <div class="product-review">
                                                <h5 class="manufacturer">
                                                    <a href="shop2.jsp">Studio Design</a>
                                                </h5>
                                                <div class="rating-box">
                                                    <ul class="rating">
                                                        <li><i class="fa fa-star-o"></i></li>
                                            ...
                                            <h4><a class="product_name" href="detailProduct.jsp">Mug Today is a good
                                                day</a></h4>
                                            <div class="price-box">
                ...
                <div class="col-lg-12">
                    <div class="li-section-title">
                        ...
                        <ul class="li-sub-category-list">
                            <li class="active"><a href="shop2.jsp">Prime Video</a></li>
                            <li><a href="shop2.jsp">Computers</a></li>
                            <li><a href="shop2.jsp">Electronics</a></li>
                        </ul>
                    </div>
                    <div class="row">
                        <div class="product-active owl-carousel">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="li-section-title">
                        ...
                        <ul class="li-sub-category-list">
                            <li class="active"><a href="shop2.jsp">Chamcham</a></li>
                            <li><a href="shop2.jsp">Sanai</a></li>
                            <li><a href="shop2.jsp">Meito</a></li>
                        </ul>
                    </div>
                    <div class="row">
                        <div class="product-active owl-carousel">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="li-static-home-content">
                        ...
                        <div class="default-btn">
                            <a href="shop2.jsp" class="links">Shopping Now</a>
                        </div>
                    </div>
                                        ...
                                        <div class="single-product-wrap">
                                            ...
                                            <div class="product_desc">
                                                <div class="product_desc_info">
                                                    ...
                                                    <h4><a class="product_name" href="detailProduct.jsp">Mug Today is a
                                                        good day</a></h4>
                                                    <div class="price-box">
                                                        <span class="new-price new-price-2">$71.80</span>
                                                        <span class="old-price">$77.22</span>
