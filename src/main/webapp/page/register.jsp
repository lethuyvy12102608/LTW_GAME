                  ...
                  <div class="language ht-language">
                    <ul class="ht-setting-list">
                      <li class="active"><a href="#"><img
                              src="images/menu/flag-icon/1.jpg" alt="">English</a></li>
                      <li><a href="#"><img
                              src="images/menu/flag-icon/2.jpg" alt="">Français</a></li>
                    </ul>
                  </div></li>
        ...
        <div class="row">
          ...
          <div class="col-lg-3">
            <div class="logo pb-sm-30 pb-xs-30">
              <a href="page1/home.jsp"> <img src="images/menu/logo/1.jpg"
                                             alt="">
              </a>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="hb-menu">
              <nav>
                <ul>
                  <li class="dropdown-holder"><a href="page1/home.jsp">Home</a>
                    <ul class="hb-dropdown">
                      <li><a href="page1/home.jsp">Home One</a></li>
                      <li><a href="index-2.html">Home Two</a></li>
                      <li><a href="index-3.html">Home Three</a></li>
                      <li><a href="index-4.html">Home Four</a></li>
                    </ul></li>
                  <li class="catmenu-dropdown megamenu-holder"><a
                          href="page1/shop.jsp">Shop</a>
                    <ul class="megamenu hb-megamenu">
                      <li><a href="page1/shop.jsp">Shop Page Layout</a>
                        <ul>
                          <li><a href="shop-3-column.html">Shop 3 Column</a></li>
                          <li><a href="shop-4-column.html">Shop 4 Column</a></li>
                          <li><a href="page1/shop.jsp">Shop Left Sidebar</a></li>
                  ...
                  <li class="catmenu-dropdown megamenu-static-holder"><a
                    ...
                    <ul class="megamenu hb-megamenu">
                      ...
                      <li><a href="page1/home.jsp">Other Pages</a>
                        <ul>
                          <li class="active"><a href="login-register.html">My
                            Account</a></li>
                          <li><a href="checkout.html">Checkout</a></li>
                          <li><a href="compare.html">Compare</a></li>
                          <li><a href="wishlist.html">Wishlist</a></li>
                          <li><a href="page/cart.jsp">Shopping Cart</a></li>
                        </ul></li>
                      <li><a href="page1/home.jsp">Other Pages 2</a>
                        <ul>
                  ...
                  <li><a href="about-us.html">About Us</a></li>
                  <li><a href="contact.html">Contact</a></li>
                  <li><a href="page1/shop.jsp">Smartwatch</a></li>
                  <li><a href="page1/shop.jsp">Accessories</a></li>
                </ul>
              </nav>
            </div>
            ...
            <div class="login-form">
              ...
              <div class="row">
                <div class="col-md-6 col-12 mb-20">
                  <label>FullName</label> <input class="mb-0" type="text" name="fullName"
                                                 placeholder="Full Name" required="required">
                </div>
                <div class="col-md-12 mb-20">
                  <label>Email*</label> <input class="mb-0" type="email" name="email"
                ...
                <div class="col-md-6 mb-20">
                  <label>Confirm Password</label> <input class="mb-0" name="confirmPassword"
                                                         type="password" placeholder="Confirm Password" required="required">
                </div>
                <c:if test="${not empty errors and not empty errors.confrimPassword}">
                  <p style="color: red;">${errors.confrimPassword}</p>
                </c:if>
                <div class="col-md-6 mb-20">
                  <label>Phone</label> <input class="mb-0" type="text" name="phone"
                                              placeholder="Phone" required="required">
                </div>
                <c:if test="${not empty errors and not empty errors.phone}">
