                ...
                <ul id="iq-sidebar-toggle" class="iq-menu">
                    ...
                    <li>
                        ...
                        <ul id="forms" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                            <li><a href="manageProduct.jsp"><i class="ri-tablet-line"></i>List Product</a></li>
                            <li><a href="addProduct.jsp"><i class="ri-device-line"></i>Add Product</a></li>
                        ...
                        <div class="iq-card-body">
                            <div class="new-user-info">
                                <form>
                                    ...
                                    <button type="submit" class="btn btn-primary" value="add">Add New Product</button>
                                </form>
                            </div>
                        </div>
                    </div>
